...
import SearchAndFilterUsers from '@/components/SearchAndFilterUsers';
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            <Card className="mx-auto mt-6 w-full">
                ...
                <CardContent className="overflow-x-auto">
                            ...
                            {users.data.length === 0 ? (
                                ...
                                users.data.map((user) => (
                                    <TableRow key={user.id}>
                                        ...
                                        <TableCell>
                                            <Badge variant={user.status === 'active' ? 'active' : 'destructive'}>{user.status}</Badge>
                                        </TableCell>
                    ...
                    <div className="mt-6">{users && <Pagination data={users} />}</div>
                </CardContent>
            </Card>
        </AppLayout>
    );
